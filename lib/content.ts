...
export const events: EventItem[] = [
  ...
  { date: "2026-08-08", title: "Interhouse sports Forum", desc: "An open conversation between families and staff about each child's progress and the term ahead.", color: "coral", image: "/photos/community-outreach.jpg" },
